...
def blank_seating_chart(number_of_rows, seats_per_row)
  ...
  number_of_rows.times do
    arr = Array.new(seats_per_row, nil)
...
# @param [Array<Array>] chart
# @param [Integer] row_index
# @param [Integer] seat_to_add
...
def count_empty_seats(chart)
  ...
  chart.reduce(0) { |sum, arr| sum + arr.tally[nil] }
end

# @param [Array<Hash>] array_of_hash_objects
