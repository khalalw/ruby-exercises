# @param [Hash<Symbol, Hash>] languages
# @param [Symbol] language_name
...
# @param [Hash<Symbol, Hash>] languages
# @param [Symbol] language_name
# @param [Symbol] info_key
# @param [Object] info_value
...
# @param [Hash<Symbol, Hash>] languages
# @param [Symbol] language_name
# @param [Hash] language_info_value
